...
async def run_issue_advisor(
    ...
    fallback = IssueAdvisorDecision(
        ...
        rationale="Issue Advisor agent failed to produce a valid analysis. Accepting with debt to avoid pipeline stall.",
        confidence=0.1,
...
async def run_issue_writer(
    ...
    class IssueWriterOutput(BaseModel):
        ...
        issue_file_path: str
        success: bool
        acceptance_criteria: list[str] = []  # Generated by writer from PRD + architecture
